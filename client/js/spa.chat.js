...
spa.chat = (function() {
  ...
  // Arguments  :
  //    * set_chat_anchor - a callback to modify the URI anchor
  //        to indicate opened or closed state. This callback must
  //        return false if the requested state cannot be met
  ...
  // Returns    : true
  // Throws     :
  //    Javascript error object and stack trace on unacceptable or
  //    missing arguments
  //
