...
spa.model = (function() {
  ...
  //      The current user object is changed to reflect the new identity. Successful
  //      completion of login publishes a 'spa-login' global custom event.
  ...
  //  * cid     - string client id. This is always defined, and is only different
  //      from the id attribute if the client data is not synced with the backend
