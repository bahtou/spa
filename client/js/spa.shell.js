...
spa.shell = (function() {
  ...
  onHashchange = function() {
    ...
    // End adjust chat compenent if changed
    return false;
  };
  ...
  initModule = function ($container) {
    ...
    */
    ...
    // Initialzie chat slider and bind click handler
    stateMap.is_chat_retracted = true;
    jqueryMap.$chat
    ...
    // Configure and initalize feature modules
    spa.chat.configModule( {} );
    spa.chat.initModule( jqueryMap.$chat );

    // Handle URI anchor change events.
    // This is done /after/ all feature modules are configured
    // and initalized, otherwise they will not be ready to handle
